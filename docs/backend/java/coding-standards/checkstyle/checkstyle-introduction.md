...
A good example of a report that can be produced using Checkstyle and Maven can be
seen [here](https://checkstyle.sourceforge.io/).

Checkstyle can check many aspects of your source code.  
It can find **class design problems**, **method design problems**, and also has the ability to check **code layout and
formatting issues**.

For a detailed list of available checks, please refer to
the [Checks page](https://checkstyle.sourceforge.io/checks.html).
